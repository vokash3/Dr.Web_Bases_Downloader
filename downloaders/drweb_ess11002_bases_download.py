...
class DrWebESS11002Downloader(DrWebESS11Downloader):
    ...
    def __init__(self, bases_directory, workdir_path):
        ...
        DrWebESS11Downloader.drweb_version = "DrWeb ESS 11.00.2"
        DrWebESS11Downloader.drweb_logfile_name = "drwreploader.log"
        DrWebESS11Downloader.drweb_archive_prefix = "DRW_ESS11.00.0,2_"
        DrWebESS11Downloader.drweb_downloaded_repo_name = "repository.zip"
        DrWebESS11Downloader.drweb_logfile_lastline_success = "Repository checked-out in"
